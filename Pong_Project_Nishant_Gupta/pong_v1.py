...
def draw(win, paddles, ball, left_score, right_score):
    ...
    left_score_text = SCORE_FONT.render(f"Player 1: {left_score}", 6, WHITE)
    right_score_text = SCORE_FONT.render(f"Player 2: {right_score}", 6, WHITE)
...
# Paddle doesn't move outside the window
...
def main():
    ...
    while run:
        ...
        if won:
            text = SCORE_FONT.render(win_text, 1, ORANGE)
